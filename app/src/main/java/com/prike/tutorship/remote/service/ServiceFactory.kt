...
/**
 * Синглтон для создния сервиса, http клиента и логгера
 */
...
object ServiceFactory {
    ...
    private fun makeLoggingInteractor(isDebug: Boolean): HttpLoggingInterceptor {
